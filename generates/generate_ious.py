...
T_w_c_ = []
pointcloud_dir = '/home/graham/datasets/fire1/lounge/pointcloud'
depth_dir = '/home/graham/datasets/fire1/lounge/depth'
pose_dir = '/home/graham/datasets/fire1/lounge/pose'
pointcloud_path = []
depth_img_list = []
...
def image_reproject_and_show(index):
    ...
    for i in range(len(depth_img_list)):
        ...
        key_points_uv_proj = key_points_uv_proj.astype(np.int16)
...
for i in tqdm.tqdm(range(len(depth_dir_list))):
    # start = time.time()
    ...
    io.savemat('iou_fire1_lounge.mat',data)
