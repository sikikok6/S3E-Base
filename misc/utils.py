...
class ModelParams:
    def __init__(self, model_params_path):
        assert os.path.exists(
            model_params_path), 'Cannot find model-specific configuration file: {}'.format(model_params_path)
        ...
        self.mink_quantization_size = params.getfloat(
...
class MinkLocParams:
    ...
    def __init__(self, params_path, model_params_path=None):
        ...
        assert os.path.exists(
            params_path), 'Cannot find configuration file: {}'.format(params_path)
