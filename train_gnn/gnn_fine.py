...
run = wandb.init(project="SE3-Backup", name="Exp_" + time_string)
...
with open(
    "/home/ubuntu-user/S3E-backup/datasetfiles/datasets/fire/pickle/fire_evaluation_database.pickle",
    "rb",
) as f:
...
with open(
    "/home/ubuntu-user/S3E-backup/datasetfiles/datasets/fire/pickle/fire_evaluation_query.pickle",
    "rb",
) as f:
    query = pickle.load(f)
...
iou = torch.tensor(
    np.load(
        "/home/ubuntu-user/S3E-backup/datasetfiles/datasets/iou_/train_fire_iou.npy"
    ),
    dtype=torch.float,
)
# iou = torch.tensor(iou / np.linalg.norm(iou, axis=1, keepdims=True))
test_iou = np.load(
    "/home/ubuntu-user/S3E-backup/datasetfiles/datasets/iou_/test_fire_iou.npy"
)
...
with open(
    "/home/ubuntu-user/S3E-backup/datasetfiles/datasets/fire/pickle/fire_train_overlap.pickle",
    "rb",
) as f:
    train_iou = pickle.load(f)

with open(
    "/home/ubuntu-user/S3E-backup/datasetfiles/datasets/fire/pickle/fire_test_overlap.pickle",
    "rb",
) as f:
        ...
        with tqdm.tqdm(
            ...
            for (
                ...
                with torch.enable_grad():
                    ...
                    loss_affinity_1 = criterion(e[: len(labels) - 1], gt_iou.cuda())
