...
import numpy as np
import tqdm
from gnn_utils import load_minkLoc_model, make_dataloader, PoseReg ,get_embeddings_3d, get_embeddings, get_poses, cal_trans_rot_errorv1
import os
import argparse
...
with tqdm.tqdm(range(80), position=0, desc='epoch', ncols=60) as tbar:
    for epoch in tbar:
        # loss status
        loss = 0.
        losses = []
